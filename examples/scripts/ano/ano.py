...
from trl.experimental.ano import ANOConfig, ANOTrainer
...
"""
python -i examples/scripts/ano/ano.py \
    --dataset_name trl-internal-testing/descriptiveness-sentiment-trl-style \
    --dataset_train_split descriptiveness \
    --learning_rate 3e-6 \
    --output_dir pythia-1b-deduped-descriptiveness-sentiment-trl-style-ano \
...
if __name__ == "__main__":
    parser = HfArgumentParser((ScriptArguments, ANOConfig, ModelConfig))
