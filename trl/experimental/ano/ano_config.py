...
@dataclass
class ANOConfig(TrainingArguments):
    r"""
    Configuration class for the [`experimental.ano.ANOTrainer`].

    This class includes only the parameters that are specific to ANO training. For a full list of training arguments,
    ...
    Parameters:
        ...
        num_ano_epochs (`int`, *optional*, defaults to `4`):
