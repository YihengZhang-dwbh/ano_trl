...
class SPOConfig(TrainingArguments):
    r"""
    Configuration class for the [`experimental.spo.SPOTrainer`].

    This class includes only the parameters that are specific to SPO training. For a full list of training arguments,
    ...
    Parameters:
        ...
        num_spo_epochs (`int`, *optional*, defaults to `4`):
